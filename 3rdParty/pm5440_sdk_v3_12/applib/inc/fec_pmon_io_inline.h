 ...
 * 
 *****************************************************************************/
#ifndef _FEC_PMON_IO_INLINE_H
#define _FEC_PMON_IO_INLINE_H
...
/*
 * ==================================================================================
 *               tsb level structure and access functions for fec_pmon
 * ==================================================================================
 */
...
static INLINE void _fec_pmon_buffer_init( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    ...
    *(UINT32 *)&b->base_address = ((pmc_handle_t *)h)->base_address;
    ...
    IOLOG( "%s", "fec_pmon_buffer_init");
    
}

#ifndef fec_pmon_buffer_flush
#define fec_pmon_buffer_flush( b ) \
       _fec_pmon_buffer_flush( LOG_CALLER b )
#endif
...
/*
 * ==================================================================================
 *                      register access functions for fec_pmon
 * ==================================================================================
 */
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_MODE_CFG_write( LOG_CALLER_DEFN
                                                                ...
                                                                UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_MODE_CFG_write", value, "(0x00000000)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_MODE_CFG,
                        value);
}
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_MODE_CFG_field_set( LOG_CALLER_DEFN
                                                                    ...
                                                                    UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_MODE_CFG_field_set", mask, ofs, value, "(0x00000000)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_MODE_CFG,
                        mask,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_MODE_CFG_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;

    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_CONFIG,
                                   PMC_FEC_PMON_REG_LPA_STATISTICS_MODE_CFG);

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_MODE_CFG_read", reg_value, "(0x00000000)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_write( LOG_CALLER_DEFN
                                                                  ...
                                                                  UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_write", value, "(0x00000004)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG,
                        value);
}
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_field_set( LOG_CALLER_DEFN
                                                                      ...
                                                                      UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_field_set", mask, ofs, value, "(0x00000004)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_read", reg_value, "(0x00000004)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_write( LOG_CALLER_DEFN
                                                                 ...
                                                                 UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_write", value, "(0x00000020)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG,
                        value);
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_field_set( LOG_CALLER_DEFN
                                                                     ...
                                                                     UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_field_set", mask, ofs, value, "(0x00000020)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_read", reg_value, "(0x00000020)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_write( LOG_CALLER_DEFN
                                                                   ...
                                                                   UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_write", value, "(0x00000024)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG,
                        value);
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_field_set( LOG_CALLER_DEFN
                                                                       ...
                                                                       UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_field_set", mask, ofs, value, "(0x00000024)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_CONFIG,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_read", reg_value, "(0x00000024)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_write( LOG_CALLER_DEFN
                                                                   ...
                                                                   UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_write", value, "(0x00000008)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL,
                        value);
}
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_field_set( LOG_CALLER_DEFN
                                                                       ...
                                                                       UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_field_set", mask, ofs, value, "(0x00000008)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_read", reg_value, "(0x00000008)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_write( LOG_CALLER_DEFN
                                                                  ...
                                                                  UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_write", value, "(0x0000000c)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL,
                        value);
}
...
static INLINE void _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_field_set( LOG_CALLER_DEFN
                                                                      ...
                                                                      UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_field_set", mask, ofs, value, "(0x0000000c)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_read", reg_value, "(0x0000000c)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__write( LOG_CALLER_DEFN
                                                                         ...
                                                                         UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__write", value, "(0x00000028)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_,
                        value);
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__field_set( LOG_CALLER_DEFN
                                                                             ...
                                                                             UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__field_set", mask, ofs, value, "(0x00000028)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__read", reg_value, "(0x00000028)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__write( LOG_CALLER_DEFN
                                                                         ...
                                                                         UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__write", value, "(0x0000002c)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_,
                        value);
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__field_set( LOG_CALLER_DEFN
                                                                             ...
                                                                             UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__field_set", mask, ofs, value, "(0x0000002c)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__read", reg_value, "(0x0000002c)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__write( LOG_CALLER_DEFN
                                                                        ...
                                                                        UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__write", value, "(0x00000030)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_,
                        value);
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__field_set( LOG_CALLER_DEFN
                                                                            ...
                                                                            UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__field_set", mask, ofs, value, "(0x00000030)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__read", reg_value, "(0x00000030)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__write( LOG_CALLER_DEFN
                                                                        ...
                                                                        UINT32 value )
{
    IOLOG( "%s <- 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__write", value, "(0x00000034)" );
    fec_pmon_reg_write( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_,
                        value);
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__field_set( LOG_CALLER_DEFN
                                                                            ...
                                                                            UINT32 value )
{
    IOLOG( "%s <- mask=0x%08x ofs=%d value=0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__field_set", mask, ofs, value, "(0x00000034)" );
    fec_pmon_field_set( b,
                        h,
                        MEM_TYPE_STATUS,
                        PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_,
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__read", reg_value, "(0x00000034)" );
    return reg_value;
}
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT);

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_read", reg_value, "(0x00000010)" );
    return reg_value;
}
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT);

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read", reg_value, "(0x00000014)" );
    return reg_value;
}
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_CORRECTED_1S_CNT_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT);

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_CORRECTED_1S_CNT_read", reg_value, "(0x00000018)" );
    return reg_value;
}
...
#endif
static INLINE UINT32 _fec_pmon_reg_LPA_STATISTICS_CORRECTED_0S_CNT_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT);

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LPA_STATISTICS_CORRECTED_0S_CNT_read", reg_value, "(0x0000001c)" );
    return reg_value;
}
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_FAILURE_STAT_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LLSA_STATISTICS_FAILURE_STAT);

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_FAILURE_STAT_read", reg_value, "(0x00000100)" );
    return reg_value;
}
...
#endif
static INLINE UINT32 _fec_pmon_reg_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 reg_value;
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT);

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read", reg_value, "(0x0000011c)" );
    return reg_value;
}
...
static INLINE void _fec_pmon_reg_LLSA_STATISTICS_CORRECTED_1S_CNT_FOR_LANES_0_TO_19_array_burst_read( LOG_CALLER_DEFN
                                                                                                      ...
                                                                                                      UINT32 *value )
{
    fec_pmon_burst_read( b,
                         h,
                         MEM_TYPE_STATUS,
                         PMC_FEC_PMON_REG_LLSA_STATISTICS_CORRECTED_1S_CNT_FOR_LANES_0_TO_19(ofs),
                         len,
                         value);

    IOLOG( "%s of %d words ofs=%d len=%d %s", "fec_pmon_reg_LLSA_STATISTICS_CORRECTED_1S_CNT_FOR_LANES_0_TO_19_array_burst_read", 20, ofs, len, "(0x00000140+(N * 4))" );
}
                                                                                                  ...
                                                                                                  UINT32 N )
{
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LLSA_STATISTICS_CORRECTED_1S_CNT_FOR_LANES_0_TO_19(N));

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CORRECTED_1S_CNT_FOR_LANES_0_TO_19_array_read", reg_value, "(0x00000140+(N * 4))" );
    return reg_value;
}
                                                                                                      ...
                                                                                                      UINT32 *value )
{
    fec_pmon_burst_read( b,
                         h,
                         MEM_TYPE_STATUS,
                         PMC_FEC_PMON_REG_LLSA_STATISTICS_CORRECTED_0S_CNT_FOR_LANES_0_TO_19(ofs),
                         len,
                         value);

    IOLOG( "%s of %d words ofs=%d len=%d %s", "fec_pmon_reg_LLSA_STATISTICS_CORRECTED_0S_CNT_FOR_LANES_0_TO_19_array_burst_read", 20, ofs, len, "(0x00000200+(N * 4))" );
}
                                                                                                  ...
                                                                                                  UINT32 N )
{
    ...
    reg_value = fec_pmon_reg_read( b,
                                   h,
                                   MEM_TYPE_STATUS,
                                   PMC_FEC_PMON_REG_LLSA_STATISTICS_CORRECTED_0S_CNT_FOR_LANES_0_TO_19(N));

    IOLOG( "%s -> 0x%08x; %s", "fec_pmon_reg_LLSA_STATISTICS_CORRECTED_0S_CNT_FOR_LANES_0_TO_19_array_read", reg_value, "(0x00000200+(N * 4))" );
    return reg_value;
}
...
static INLINE void _fec_pmon_field_LPA_STATS_COUNTER_MODE_set( LOG_CALLER_DEFN
                                                               ...
                                                               UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_COUNTER_MODE_set", value );

    /* (0x00000000 bits 1:0) bits 0:1 use field LPA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LPA_STATISTICS_MODE_CFG */
    _fec_pmon_reg_LPA_STATISTICS_MODE_CFG_field_set( LOG_CALLER_ARGS
                                                     b,
                                                     h,
                                                     FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_MSK,
                                                     FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_OFF,
                                                     (value & 0x3));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_COUNTER_MODE_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000000 bits 1:0) bits 0:1 use field LPA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LPA_STATISTICS_MODE_CFG */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_MODE_CFG_read( LOG_CALLER_ARGS b, h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_MSK) >> FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_COUNTER_MODE_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_PRESET_VALUE_set( LOG_CALLER_DEFN
                                                               ...
                                                               UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_PRESET_VALUE_set", value );

    /* (0x00000004 bits 31:0) bits 0:31 use field LPA_STATS_PRESET_VALUE of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG */
    _fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_field_set( LOG_CALLER_ARGS
                                                       b,
                                                       h,
                                                       FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_MSK,
                                                       FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_OFF,
                                                       (value & 0xffffffff));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_PRESET_VALUE_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000004 bits 31:0) bits 0:31 use field LPA_STATS_PRESET_VALUE of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_read( LOG_CALLER_ARGS
                                                              b,
                                                              h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_MSK) >> FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_PRESET_VALUE_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_COUNTER_MODE_set( LOG_CALLER_DEFN
                                                                ...
                                                                UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_COUNTER_MODE_set", value );

    /* (0x00000020 bits 1:0) bits 0:1 use field LLSA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG */
    _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_field_set( LOG_CALLER_ARGS
                                                      b,
                                                      h,
                                                      FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_MSK,
                                                      FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_OFF,
                                                      (value & 0x3));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_COUNTER_MODE_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000020 bits 1:0) bits 0:1 use field LLSA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_read( LOG_CALLER_ARGS b, h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_COUNTER_MODE_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_LATCH_SOURCE_set( LOG_CALLER_DEFN
                                                                ...
                                                                UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_LATCH_SOURCE_set", value );

    /* (0x00000020 bits 2) field LLSA_STATS_LATCH_SOURCE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG */
    _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_field_set( LOG_CALLER_ARGS
                                                      b,
                                                      h,
                                                      FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_LATCH_SOURCE_MSK,
                                                      FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_LATCH_SOURCE_OFF,
                                                      value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_LATCH_SOURCE_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    /* (0x00000020 bits 2) field LLSA_STATS_LATCH_SOURCE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_read( LOG_CALLER_ARGS b, h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_LATCH_SOURCE_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_LATCH_SOURCE_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_LATCH_SOURCE_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_PRESET_VALUE_set( LOG_CALLER_DEFN
                                                                ...
                                                                UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_PRESET_VALUE_set", value );

    /* (0x00000024 bits 31:0) bits 0:31 use field LLSA_STATS_PRESET_VALUE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG */
    _fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_field_set( LOG_CALLER_ARGS
                                                        b,
                                                        h,
                                                        FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_MSK,
                                                        FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_OFF,
                                                        (value & 0xffffffff));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_PRESET_VALUE_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000024 bits 31:0) bits 0:31 use field LLSA_STATS_PRESET_VALUE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_read( LOG_CALLER_ARGS
                                                               b,
                                                               h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_PRESET_VALUE_get", value );
...
static INLINE void _fec_pmon_field_range_LPA_STATS_COUNTER_MODE_set( LOG_CALLER_DEFN
                                                                     ...
                                                                     UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_COUNTER_MODE_set", start_bit, stop_bit, value );
    ...
    /* (0x00000000 bits 1:0) bits 0:1 use field LPA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LPA_STATISTICS_MODE_CFG */
    {
        ...
        _fec_pmon_reg_LPA_STATISTICS_MODE_CFG_field_set( LOG_CALLER_ARGS
                                                         b,
                                                         h,
                                                         subfield_mask << (FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_OFF + subfield_offset),
                                                         FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_OFF + subfield_offset,
                                                                       ...
                                                                       UINT32 stop_bit )
{
    ...
    /* (0x00000000 bits 1:0) bits 0:1 use field LPA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LPA_STATISTICS_MODE_CFG */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_MODE_CFG_read( LOG_CALLER_ARGS b, h);
    field_value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_MSK)
                  >> FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_MSK, FEC_PMON_REG_LPA_STATISTICS_MODE_CFG_BIT_LPA_STATS_COUNTER_MODE_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_COUNTER_MODE_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_field_range_LPA_STATS_PRESET_VALUE_set( LOG_CALLER_DEFN
                                                                     ...
                                                                     UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_PRESET_VALUE_set", start_bit, stop_bit, value );
    ...
    /* (0x00000004 bits 31:0) bits 0:31 use field LPA_STATS_PRESET_VALUE of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG */
    {
        ...
        _fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_field_set( LOG_CALLER_ARGS
                                                           b,
                                                           h,
                                                           subfield_mask << (FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_OFF + subfield_offset),
                                                           FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_OFF + subfield_offset,
                                                           value >> subfield_shift);
    }
}
                                                                       ...
                                                                       UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_PRESET_CFG_read( LOG_CALLER_ARGS
                                                              b,
                                                              h);
    field_value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_MSK)
                  >> FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_MSK, FEC_PMON_REG_LPA_STATISTICS_PRESET_CFG_BIT_LPA_STATS_PRESET_VALUE_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_PRESET_VALUE_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_field_range_LLSA_STATS_COUNTER_MODE_set( LOG_CALLER_DEFN
                                                                      ...
                                                                      UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_COUNTER_MODE_set", start_bit, stop_bit, value );
    ...
    /* (0x00000020 bits 1:0) bits 0:1 use field LLSA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG */
    {
        ...
        _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_field_set( LOG_CALLER_ARGS
                                                          b,
                                                          h,
                                                          subfield_mask << (FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_OFF + subfield_offset),
                                                          FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_OFF + subfield_offset,
                                                          value >> subfield_shift);
    }
}
                                                                        ...
                                                                        UINT32 stop_bit )
{
    ...
    /* (0x00000020 bits 1:0) bits 0:1 use field LLSA_STATS_COUNTER_MODE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_MODE_CFG_read( LOG_CALLER_ARGS b, h);
    field_value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_MSK)
                  >> FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_MSK, FEC_PMON_REG_LLSA_STATISTICS_MODE_CFG_BIT_LLSA_STATS_COUNTER_MODE_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_COUNTER_MODE_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_field_range_LLSA_STATS_PRESET_VALUE_set( LOG_CALLER_DEFN
                                                                      ...
                                                                      UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_PRESET_VALUE_set", start_bit, stop_bit, value );
    ...
    /* (0x00000024 bits 31:0) bits 0:31 use field LLSA_STATS_PRESET_VALUE of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG */
    {
        ...
        _fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_field_set( LOG_CALLER_ARGS
                                                            b,
                                                            h,
                                                            subfield_mask << (FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_OFF + subfield_offset),
                                                            FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_OFF + subfield_offset,
                                                            value >> subfield_shift);
    }
}
                                                                        ...
                                                                        UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_PRESET_CFG_read( LOG_CALLER_ARGS
                                                               b,
                                                               h);
    field_value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_MSK)
                  >> FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_MSK, FEC_PMON_REG_LLSA_STATISTICS_PRESET_CFG_BIT_LLSA_STATS_PRESET_VALUE_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_PRESET_VALUE_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_field_LPA_STATS_FP_PRESET_set( LOG_CALLER_DEFN
                                                            ...
                                                            UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_FP_PRESET_set", value );

    /* (0x00000008 bits 0) field LPA_STATS_FP_PRESET of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_field_set( LOG_CALLER_ARGS
                                                        b,
                                                        h,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_FP_PRESET_MSK,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_FP_PRESET_OFF,
                                                        value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_FP_PRESET_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000008 bits 0) field LPA_STATS_FP_PRESET of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_read( LOG_CALLER_ARGS
                                                               b,
                                                               h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_FP_PRESET_MSK) >> FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_FP_PRESET_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_FP_PRESET_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_UNCORR_CWDS_PRESET_set( LOG_CALLER_DEFN
                                                                     ...
                                                                     UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_UNCORR_CWDS_PRESET_set", value );

    /* (0x00000008 bits 1) field LPA_STATS_UNCORR_CWDS_PRESET of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_field_set( LOG_CALLER_ARGS
                                                        b,
                                                        h,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_UNCORR_CWDS_PRESET_MSK,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_UNCORR_CWDS_PRESET_OFF,
                                                        value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_UNCORR_CWDS_PRESET_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_read( LOG_CALLER_ARGS
                                                               b,
                                                               h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_UNCORR_CWDS_PRESET_MSK) >> FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_UNCORR_CWDS_PRESET_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_UNCORR_CWDS_PRESET_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_CORR_1S_PRESET_set( LOG_CALLER_DEFN
                                                                 ...
                                                                 UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_CORR_1S_PRESET_set", value );

    /* (0x00000008 bits 2) field LPA_STATS_CORR_1S_PRESET of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_field_set( LOG_CALLER_ARGS
                                                        b,
                                                        h,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_1S_PRESET_MSK,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_1S_PRESET_OFF,
                                                        value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_CORR_1S_PRESET_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_read( LOG_CALLER_ARGS
                                                               b,
                                                               h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_1S_PRESET_MSK) >> FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_1S_PRESET_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_CORR_1S_PRESET_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_CORR_0S_PRESET_set( LOG_CALLER_DEFN
                                                                 ...
                                                                 UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_CORR_0S_PRESET_set", value );

    /* (0x00000008 bits 3) field LPA_STATS_CORR_0S_PRESET of register PMC_FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_field_set( LOG_CALLER_ARGS
                                                        b,
                                                        h,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_0S_PRESET_MSK,
                                                        FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_0S_PRESET_OFF,
                                                        value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_CORR_0S_PRESET_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_PRESET_CTRL_read( LOG_CALLER_ARGS
                                                               b,
                                                               h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_0S_PRESET_MSK) >> FEC_PMON_REG_LPA_STATISTICS_PRESET_CTRL_BIT_LPA_STATS_CORR_0S_PRESET_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_CORR_0S_PRESET_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_FP_CLEAR_set( LOG_CALLER_DEFN
                                                           ...
                                                           UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_FP_CLEAR_set", value );

    /* (0x0000000c bits 0) field LPA_STATS_FP_CLEAR of register PMC_FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_field_set( LOG_CALLER_ARGS
                                                       b,
                                                       h,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_FP_CLEAR_MSK,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_FP_CLEAR_OFF,
                                                       value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_FP_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x0000000c bits 0) field LPA_STATS_FP_CLEAR of register PMC_FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_read( LOG_CALLER_ARGS
                                                              b,
                                                              h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_FP_CLEAR_MSK) >> FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_FP_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_FP_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_UNCORR_CWDS_CLEAR_set( LOG_CALLER_DEFN
                                                                    ...
                                                                    UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_UNCORR_CWDS_CLEAR_set", value );

    /* (0x0000000c bits 1) field LPA_STATS_UNCORR_CWDS_CLEAR of register PMC_FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_field_set( LOG_CALLER_ARGS
                                                       b,
                                                       h,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_UNCORR_CWDS_CLEAR_MSK,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_UNCORR_CWDS_CLEAR_OFF,
                                                       value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_UNCORR_CWDS_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_read( LOG_CALLER_ARGS
                                                              b,
                                                              h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_UNCORR_CWDS_CLEAR_MSK) >> FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_UNCORR_CWDS_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_UNCORR_CWDS_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_CORR_1S_CLEAR_set( LOG_CALLER_DEFN
                                                                ...
                                                                UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_CORR_1S_CLEAR_set", value );

    /* (0x0000000c bits 2) field LPA_STATS_CORR_1S_CLEAR of register PMC_FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_field_set( LOG_CALLER_ARGS
                                                       b,
                                                       h,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_1S_CLEAR_MSK,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_1S_CLEAR_OFF,
                                                       value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_CORR_1S_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_read( LOG_CALLER_ARGS
                                                              b,
                                                              h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_1S_CLEAR_MSK) >> FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_1S_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_CORR_1S_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_LPA_STATS_CORR_0S_CLEAR_set( LOG_CALLER_DEFN
                                                                ...
                                                                UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LPA_STATS_CORR_0S_CLEAR_set", value );

    /* (0x0000000c bits 3) field LPA_STATS_CORR_0S_CLEAR of register PMC_FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL */
    _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_field_set( LOG_CALLER_ARGS
                                                       b,
                                                       h,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_0S_CLEAR_MSK,
                                                       FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_0S_CLEAR_OFF,
                                                       value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_CORR_0S_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CLEAR_CTRL_read( LOG_CALLER_ARGS
                                                              b,
                                                              h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_0S_CLEAR_MSK) >> FEC_PMON_REG_LPA_STATISTICS_CLEAR_CTRL_BIT_LPA_STATS_CORR_0S_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_CORR_0S_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_CORR_1S_PRESET_set( LOG_CALLER_DEFN
                                                                  ...
                                                                  UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_1S_PRESET_set", value );

    /* (0x00000028 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_1S_PRESET of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_ */
    _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__field_set( LOG_CALLER_ARGS
                                                              b,
                                                              h,
                                                              FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_MSK,
                                                              FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_OFF,
                                                              (value & 0xfffff));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_CORR_1S_PRESET_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000028 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_1S_PRESET of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_ */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__read( LOG_CALLER_ARGS
                                                                     b,
                                                                     h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_1S_PRESET_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_UNCORR_CWDS_PRESET_set( LOG_CALLER_DEFN
                                                                      ...
                                                                      UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_UNCORR_CWDS_PRESET_set", value );

    /* (0x00000028 bits 20) field LLSA_STATS_UNCORR_CWDS_PRESET of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_ */
    _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__field_set( LOG_CALLER_ARGS
                                                              b,
                                                              h,
                                                              FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_PRESET_MSK,
                                                              FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_PRESET_OFF,
                                                              value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_UNCORR_CWDS_PRESET_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__read( LOG_CALLER_ARGS
                                                                     b,
                                                                     h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_PRESET_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_PRESET_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_UNCORR_CWDS_PRESET_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_CORR_0S_PRESET_set( LOG_CALLER_DEFN
                                                                  ...
                                                                  UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_0S_PRESET_set", value );

    /* (0x0000002c bits 19:0) bits 0:19 use field LLSA_STATS_CORR_0S_PRESET of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_ */
    _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__field_set( LOG_CALLER_ARGS
                                                              b,
                                                              h,
                                                              FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_MSK,
                                                              FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_OFF,
                                                              (value & 0xfffff));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_CORR_0S_PRESET_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x0000002c bits 19:0) bits 0:19 use field LLSA_STATS_CORR_0S_PRESET of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_ */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__read( LOG_CALLER_ARGS
                                                                     b,
                                                                     h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_0S_PRESET_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_CORR_1S_CLEAR_set( LOG_CALLER_DEFN
                                                                 ...
                                                                 UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_1S_CLEAR_set", value );

    /* (0x00000030 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_1S_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_ */
    _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__field_set( LOG_CALLER_ARGS
                                                             b,
                                                             h,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_MSK,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_OFF,
                                                             (value & 0xfffff));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_CORR_1S_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000030 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_1S_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_ */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_1S_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_UNCORR_CWDS_CLEAR_set( LOG_CALLER_DEFN
                                                                     ...
                                                                     UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_UNCORR_CWDS_CLEAR_set", value );

    /* (0x00000030 bits 20) field LLSA_STATS_UNCORR_CWDS_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_ */
    _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__field_set( LOG_CALLER_ARGS
                                                             b,
                                                             h,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_CLEAR_MSK,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_CLEAR_OFF,
                                                             value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_UNCORR_CWDS_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_CLEAR_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_UNCORR_CWDS_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_UNCORR_CWDS_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_OTU_FAIL_CLEAR_set( LOG_CALLER_DEFN
                                                                  ...
                                                                  UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_OTU_FAIL_CLEAR_set", value );

    /* (0x00000030 bits 21) field LLSA_STATS_OTU_FAIL_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_ */
    _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__field_set( LOG_CALLER_ARGS
                                                             b,
                                                             h,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_OTU_FAIL_CLEAR_MSK,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_OTU_FAIL_CLEAR_OFF,
                                                             value);
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_OTU_FAIL_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_OTU_FAIL_CLEAR_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_OTU_FAIL_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_OTU_FAIL_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_LLSA_STATS_CORR_0S_CLEAR_set( LOG_CALLER_DEFN
                                                                 ...
                                                                 UINT32 value )
{
    IOLOG( "%s <= 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_0S_CLEAR_set", value );

    /* (0x00000034 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_0S_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_ */
    _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__field_set( LOG_CALLER_ARGS
                                                             b,
                                                             h,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_MSK,
                                                             FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_OFF,
                                                             (value & 0xfffff));
}
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_CORR_0S_CLEAR_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000034 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_0S_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_ */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_CORR_0S_CLEAR_get", value );
...
static INLINE void _fec_pmon_field_range_LLSA_STATS_CORR_1S_PRESET_set( LOG_CALLER_DEFN
                                                                        ...
                                                                        UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_1S_PRESET_set", start_bit, stop_bit, value );
    ...
    /* (0x00000028 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_1S_PRESET of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_ */
    {
        ...
        _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__field_set( LOG_CALLER_ARGS
                                                                  b,
                                                                  h,
                                                                  subfield_mask << (FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_OFF + subfield_offset),
                                                                  FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_OFF + subfield_offset,
                                                                  value >> subfield_shift);
    }
}
                                                                          ...
                                                                          UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_1_2__read( LOG_CALLER_ARGS
                                                                     b,
                                                                     h);
    field_value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_MSK)
                  >> FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_MSK, FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_PRESET_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_1S_PRESET_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_field_range_LLSA_STATS_CORR_0S_PRESET_set( LOG_CALLER_DEFN
                                                                        ...
                                                                        UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_0S_PRESET_set", start_bit, stop_bit, value );
    ...
    /* (0x0000002c bits 19:0) bits 0:19 use field LLSA_STATS_CORR_0S_PRESET of register PMC_FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_ */
    {
        ...
        _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__field_set( LOG_CALLER_ARGS
                                                                  b,
                                                                  h,
                                                                  subfield_mask << (FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_OFF + subfield_offset),
                                                                  FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_OFF + subfield_offset,
                                                                  value >> subfield_shift);
    }
}
                                                                          ...
                                                                          UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_PRESET_CTRL_2_2__read( LOG_CALLER_ARGS
                                                                     b,
                                                                     h);
    field_value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_MSK)
                  >> FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_MSK, FEC_PMON_REG_LLSA_STATISTICS_PRESET_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_PRESET_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_0S_PRESET_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_field_range_LLSA_STATS_CORR_1S_CLEAR_set( LOG_CALLER_DEFN
                                                                       ...
                                                                       UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_1S_CLEAR_set", start_bit, stop_bit, value );
    ...
    /* (0x00000030 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_1S_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_ */
    {
        ...
        _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__field_set( LOG_CALLER_ARGS
                                                                 b,
                                                                 h,
                                                                 subfield_mask << (FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_OFF + subfield_offset),
                                                                 FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_OFF + subfield_offset,
                                                                 value >> subfield_shift);
    }
}
                                                                         ...
                                                                         UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_1_2__read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    field_value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_MSK)
                  >> FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_MSK, FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_1_2_BIT_LLSA_STATS_CORR_1S_CLEAR_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_1S_CLEAR_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_field_range_LLSA_STATS_CORR_0S_CLEAR_set( LOG_CALLER_DEFN
                                                                       ...
                                                                       UINT32 value )
{
    IOLOG( "%s <= start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_0S_CLEAR_set", start_bit, stop_bit, value );
    ...
    /* (0x00000034 bits 19:0) bits 0:19 use field LLSA_STATS_CORR_0S_CLEAR of register PMC_FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_ */
    {
        ...
        _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__field_set( LOG_CALLER_ARGS
                                                                 b,
                                                                 h,
                                                                 subfield_mask << (FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_OFF + subfield_offset),
                                                                 FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_OFF + subfield_offset,
                                                                 value >> subfield_shift);
    }
}
                                                                         ...
                                                                         UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CLEAR_CTRL_2_2__read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    field_value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_MSK)
                  >> FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_MSK, FEC_PMON_REG_LLSA_STATISTICS_CLEAR_CTRL_2_2_BIT_LLSA_STATS_CORR_0S_CLEAR_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_CORR_0S_CLEAR_get", start_bit, stop_bit, value );
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_FP_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000010 bits 31:0) bits 0:31 use field LPA_STATS_FP of register PMC_FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_read( LOG_CALLER_ARGS
                                                                       b,
                                                                       h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_BIT_LPA_STATS_FP_MSK) >> FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_BIT_LPA_STATS_FP_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_FP_get", value );
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_UNCORR_CWDS_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000014 bits 31:0) bits 0:31 use field LPA_STATS_UNCORR_CWDS of register PMC_FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read( LOG_CALLER_ARGS
                                                                             b,
                                                                             h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LPA_STATS_UNCORR_CWDS_MSK) >> FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LPA_STATS_UNCORR_CWDS_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_UNCORR_CWDS_get", value );
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_CORR_1S_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000018 bits 31:0) bits 0:31 use field LPA_STATS_CORR_1S of register PMC_FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CORRECTED_1S_CNT_read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT_BIT_LPA_STATS_CORR_1S_MSK) >> FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT_BIT_LPA_STATS_CORR_1S_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_CORR_1S_get", value );
...
#endif
static INLINE UINT32 _fec_pmon_field_LPA_STATS_CORR_0S_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x0000001c bits 31:0) bits 0:31 use field LPA_STATS_CORR_0S of register PMC_FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT */
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CORRECTED_0S_CNT_read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT_BIT_LPA_STATS_CORR_0S_MSK) >> FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT_BIT_LPA_STATS_CORR_0S_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LPA_STATS_CORR_0S_get", value );
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_OTU_FAIL_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x00000100 bits 0) field LLSA_STATS_OTU_FAIL of register PMC_FEC_PMON_REG_LLSA_STATISTICS_FAILURE_STAT */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_FAILURE_STAT_read( LOG_CALLER_ARGS
                                                                 b,
                                                                 h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_FAILURE_STAT_BIT_LLSA_STATS_OTU_FAIL_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_FAILURE_STAT_BIT_LLSA_STATS_OTU_FAIL_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_OTU_FAIL_get", value );
...
#endif
static INLINE UINT32 _fec_pmon_field_LLSA_STATS_UNCORR_CWDS_get( LOG_CALLER_DEFN fec_pmon_buffer_t *b, fec_pmon_handle_t *h )
{
    UINT32 value = 0;
    UINT32 reg_value;

    /* (0x0000011c bits 31:0) bits 0:31 use field LLSA_STATS_UNCORR_CWDS of register PMC_FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT */
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read( LOG_CALLER_ARGS
                                                                              b,
                                                                              h);
    value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LLSA_STATS_UNCORR_CWDS_MSK) >> FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LLSA_STATS_UNCORR_CWDS_OFF;
    IOLOG( "%s -> 0x%08x", "fec_pmon_field_LLSA_STATS_UNCORR_CWDS_get", value );
                                                             ...
                                                             UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_read( LOG_CALLER_ARGS
                                                                       b,
                                                                       h);
    field_value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_BIT_LPA_STATS_FP_MSK)
                  >> FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_BIT_LPA_STATS_FP_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_BIT_LPA_STATS_FP_MSK, FEC_PMON_REG_LPA_STATISTICS_OTU_FRAME_PULSE_CNT_BIT_LPA_STATS_FP_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_FP_get", start_bit, stop_bit, value );
                                                                      ...
                                                                      UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read( LOG_CALLER_ARGS
                                                                             b,
                                                                             h);
    field_value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LPA_STATS_UNCORR_CWDS_MSK)
                  >> FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LPA_STATS_UNCORR_CWDS_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LPA_STATS_UNCORR_CWDS_MSK, FEC_PMON_REG_LPA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LPA_STATS_UNCORR_CWDS_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_UNCORR_CWDS_get", start_bit, stop_bit, value );
                                                                  ...
                                                                  UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CORRECTED_1S_CNT_read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    field_value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT_BIT_LPA_STATS_CORR_1S_MSK)
                  >> FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT_BIT_LPA_STATS_CORR_1S_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT_BIT_LPA_STATS_CORR_1S_MSK, FEC_PMON_REG_LPA_STATISTICS_CORRECTED_1S_CNT_BIT_LPA_STATS_CORR_1S_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_CORR_1S_get", start_bit, stop_bit, value );
                                                                  ...
                                                                  UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LPA_STATISTICS_CORRECTED_0S_CNT_read( LOG_CALLER_ARGS
                                                                    b,
                                                                    h);
    field_value = (reg_value & FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT_BIT_LPA_STATS_CORR_0S_MSK)
                  >> FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT_BIT_LPA_STATS_CORR_0S_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT_BIT_LPA_STATS_CORR_0S_MSK, FEC_PMON_REG_LPA_STATISTICS_CORRECTED_0S_CNT_BIT_LPA_STATS_CORR_0S_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LPA_STATS_CORR_0S_get", start_bit, stop_bit, value );
                                                                       ...
                                                                       UINT32 stop_bit )
{
    ...
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_read( LOG_CALLER_ARGS
                                                                              b,
                                                                              h);
    field_value = (reg_value & FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LLSA_STATS_UNCORR_CWDS_MSK)
                  >> FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LLSA_STATS_UNCORR_CWDS_OFF;
    IOLOG(  "field_value = (%08x & 0x%x) >> %d; // (%08x)", reg_value, FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LLSA_STATS_UNCORR_CWDS_MSK, FEC_PMON_REG_LLSA_STATISTICS_UNCORRECTED_CODEWORDS_CNT_BIT_LLSA_STATS_UNCORR_CWDS_OFF, field_value );
    value |= ((field_value >> subfield_offset) & subfield_mask) << subfield_shift;
    IOLOG(  "value |= ((%08x >> %d) & 0x%x << %d); // (%08x)", field_value, subfield_offset, subfield_mask, subfield_shift, ((field_value >> subfield_offset) & subfield_mask) << subfield_shift );
    IOLOG( "%s -> start_bit=%d stop_bit=%d 0x%08x", "fec_pmon_field_range_LLSA_STATS_UNCORR_CWDS_get", start_bit, stop_bit, value );
...
static INLINE void _fec_pmon_lfield_LLSA_STATS_LANE_CORR_1S_get( LOG_CALLER_DEFN
                                                                 ...
                                                                 UINT32 value[20] )
{
    _fec_pmon_reg_LLSA_STATISTICS_CORRECTED_1S_CNT_FOR_LANES_0_TO_19_array_burst_read( LOG_CALLER_ARGS
                                                                                       b,
                                                                                       h,
                                                                                       0,
                                                                                       20,
                                                                                       (UINT32 *)value);
    IOLOG( "%s ", "fec_pmon_lfield_LLSA_STATS_LANE_CORR_1S_get");
}
...
static INLINE void _fec_pmon_lfield_LLSA_STATS_LANE_CORR_0S_get( LOG_CALLER_DEFN
                                                                 ...
                                                                 UINT32 value[20] )
{
    _fec_pmon_reg_LLSA_STATISTICS_CORRECTED_0S_CNT_FOR_LANES_0_TO_19_array_burst_read( LOG_CALLER_ARGS
                                                                                       b,
                                                                                       h,
                                                                                       0,
                                                                                       20,
                                                                                       (UINT32 *)value);
    IOLOG( "%s ", "fec_pmon_lfield_LLSA_STATS_LANE_CORR_0S_get");
}
                                                                         ...
                                                                         UINT32 stop_bit )
{
    ...
    num_bits = start_bit - stop_bit + 1;
    mask = 0xffffffff >> (32-num_bits);
    word_number = start_bit / 32;
    field_ofs = start_bit % 32;
    if (stop_bit / 32 != word_number) {
        IOLOG( "BUG: %s does not support ranges that span multiple registers -- fix code generator - start_bit=%d, stop_bit=%d", "fec_pmon_lfield_range_LLSA_STATS_LANE_CORR_1S_get", start_bit, stop_bit );
    }
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CORRECTED_1S_CNT_FOR_LANES_0_TO_19_array_read( LOG_CALLER_ARGS
                                                                                             b,
                                                                                             h,
                                                                                             word_number);
    value = (reg_value >> field_ofs) & mask;
    IOLOG( "%s -> start_bit=%d stop_bit=%d value=0x%08x", "fec_pmon_lfield_range_LLSA_STATS_LANE_CORR_1S_get", start_bit, stop_bit, value );
    return value;
}
                                                                         ...
                                                                         UINT32 stop_bit )
{
    ...
    field_ofs = start_bit % 32;
    if (stop_bit / 32 != word_number) {
        IOLOG( "BUG: %s does not support ranges that span multiple registers -- fix code generator - start_bit=%d, stop_bit=%d", "fec_pmon_lfield_range_LLSA_STATS_LANE_CORR_0S_get", start_bit, stop_bit );
    }
    reg_value = _fec_pmon_reg_LLSA_STATISTICS_CORRECTED_0S_CNT_FOR_LANES_0_TO_19_array_read( LOG_CALLER_ARGS
                                                                                             b,
                                                                                             h,
                                                                                             word_number);
    value = (reg_value >> field_ofs) & mask;
    IOLOG( "%s -> start_bit=%d stop_bit=%d value=0x%08x", "fec_pmon_lfield_range_LLSA_STATS_LANE_CORR_0S_get", start_bit, stop_bit, value );
    return value;
}
