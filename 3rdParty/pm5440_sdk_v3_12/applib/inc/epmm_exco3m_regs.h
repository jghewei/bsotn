 ...
 *     epmm_exco3m block
 *****************************************************************************/
#ifndef _EPMM_EXCO3M_REGS_H
#define _EPMM_EXCO3M_REGS_H
...
/*--------------------.
 | register addresses |
 +-------------------*/
#define PMC_EXCO3M_REG_SW_RESET                     0x00001000
#define PMC_EXCO3M_REG_RX_PUSH_CFG_REG              0x00001010
#define PMC_EXCO3M_REG_TX_GLOBAL_CTRL               0x00001024
#define PMC_EXCO3M_REG_TX_FAULT_CTRL                0x00001028
#define PMC_EXCO3M_REG_TX_INT_VAL                   0x00001030
#define PMC_EXCO3M_REG_TX_INT_STAT                  0x00001034
#define PMC_EXCO3M_REG_TX_INT_EN                    0x00001038
#define PMC_EXCO3M_REG_TX_PCS_BER_CNT_LOWER         0x00001040
#define PMC_EXCO3M_REG_TX_PCS_BER_CNT_UPPER         0x00001044
#define PMC_EXCO3M_REG_TX_PCS_BLOCK_ERR_CNT_LOWER   0x00001048
#define PMC_EXCO3M_REG_TX_PCS_BLOCK_ERR_CNT_UPPER   0x0000104c
#define PMC_EXCO3M_REG_TX_LANE_INFO( N )            (0x00001080 + (N) * 4)
#define PMC_EXCO3M_REG_TX_LANE_INT_VAL( N )         (0x00001100 + (N) * 4)
#define PMC_EXCO3M_REG_TX_LANE_INT_STAT( N )        (0x00001180 + (N) * 4)
#define PMC_EXCO3M_REG_TX_LANE_INT_EN( N )          (0x00001200 + (N) * 4)
#define PMC_EXCO3M_REG_TX_LANE_PCS_BIP_ERR_CNT( N ) (0x00001300 + (N) * 4)
#define PMC_EXCO3M_REG_RX_GLOBAL_CTRL               0x00001424
#define PMC_EXCO3M_REG_RX_FAULT_CTRL                0x00001428
#define PMC_EXCO3M_REG_RX_INT_VAL                   0x00001430
#define PMC_EXCO3M_REG_RX_INT_STAT                  0x00001434
#define PMC_EXCO3M_REG_RX_INT_EN                    0x00001438
#define PMC_EXCO3M_REG_RX_1027B_BER_CNT_LOWER       0x00001440
#define PMC_EXCO3M_REG_RX_1027B_BER_CNT_UPPER       0x00001444
#define PMC_EXCO3M_REG_RX_PCS_BLOCK_ERR_CNT_LOWER   0x00001448
#define PMC_EXCO3M_REG_RX_PCS_BLOCK_ERR_CNT_UPPER   0x0000144c
#define PMC_EXCO3M_REG_RX_LANE_INT_VAL( N )         (0x00001580 + (N) * 4)
#define PMC_EXCO3M_REG_RX_LANE_INT_STAT( N )        (0x00001600 + (N) * 4)
#define PMC_EXCO3M_REG_RX_LANE_INT_EN( N )          (0x00001680 + (N) * 4)
#define PMC_EXCO3M_REG_RX_LANE_OTN_BIP_ERR_CNT( N ) (0x00001700 + (N) * 4)
...
/*------------------------------------------.
 | Register 0x00001044 TX_PCS_BER_CNT_UPPER |
 +------------------------------------------+
...
/*------------------------------------------------.
 | Register 0x0000104c TX_PCS_BLOCK_ERR_CNT_UPPER |
 +------------------------------------------------+
...
/*--------------------------------------------.
 | Register 0x00001444 RX_1027B_BER_CNT_UPPER |
 +--------------------------------------------+
...
/*------------------------------------------------.
 | Register 0x0000144c RX_PCS_BLOCK_ERR_CNT_UPPER |
 +------------------------------------------------+
