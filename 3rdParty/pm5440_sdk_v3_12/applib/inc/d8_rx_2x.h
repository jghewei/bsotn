...
* --------------------------------------------------------------------------
*   DESCRIPTION :
*     D8_RX_2X serdes block include file only visible by internal blocks or ss.
*
*   NOTES:
*
*******************************************************************************/
...
#define D8_RX_2X_MAX_NUM_SERDES 2

/* D8_RX_2X User-defined pattern size in word of 32 bit */
#define D8_RX_2X_USR_PATT_NUM_WORD 2
...
*******************************************************************************/
typedef struct {
    UINT8 patt_mon_bus_width;
} d8_rx_2x_cfg_t;


/*******************************************************************************
* STRUCTURE: d8_rx_2x_var_t
* ______________________________________________________________________________
*
* DESCRIPTION:
...
typedef struct {
    BOOL8 reset;
    BOOL8 patt_mon_enable;
    BOOL8 loopback_enable;
} d8_rx_2x_var_t;

/*******************************************************************************
* STRUCTURE: d8_rx_2x_handle_struct_t
* ______________________________________________________________________________
*
* DESCRIPTION:
...
*   See typedef.
*******************************************************************************/
typedef struct d8_rx_2x_handle_struct_t {
    pmc_handle_t base;    
    d8_rx_2x_cfg_t cfg;
    d8_rx_2x_var_t *var;

} d8_rx_2x_handle_struct_t;

/*! D8_RX_2X block handle used by its parent */
typedef struct d8_rx_2x_handle_struct_t d8_rx_2x_handle_t;
