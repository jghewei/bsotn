 ...
 * implied warranty.
 *-----------------------------------------------------------------------------
 * $Id: tclXdbg.c,v 1.1.1.1 2001/04/20 15:03:06 karl Exp $
 *-----------------------------------------------------------------------------
 */
 ...
 *-----------------------------------------------------------------------------
 */
static void PrintStr (FILE *filePtr, const char *string, int numChars)
{
    int idx;
 ...
 */
static void
TraceCode (traceInfo_pt traceInfoPtr, int level, char *command, 
           int argc, char **argv)
{
 ...
 */
static void
CmdTraceRoutine (ClientData clientData, Tcl_Interp *interp, int level, 
 ...
 */
static int
Tcl_CmdtraceCmd (ClientData clientData, Tcl_Interp *interp, 
                 int argc, char **argv)
{
