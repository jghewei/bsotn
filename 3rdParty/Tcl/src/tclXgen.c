 ...
 * implied warranty.
 *-----------------------------------------------------------------------------
 * $Id: tclXgen.c,v 1.1.1.1 2001/04/20 15:03:06 karl Exp $
 *-----------------------------------------------------------------------------
 */
...
const char *tclxVersion       = "?";   /* Extended Tcl version number.            */
 ...
 */
int
Tcl_InfoxCmd (ClientData clientData, Tcl_Interp *interp, int argc, char **argv)
{
    (void) clientData;
    if (argc != 2) {
 ...
 */
int
Tcl_LoopCmd (ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int   result = TCL_OK;
