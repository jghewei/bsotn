 ...
 *
 * $Id: tclCmdAH.c,v 1.1.1.1 2001/04/20 15:03:06 karl Exp $
 */
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_BreakCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    (void) dummy;
    if (argc != 1) {
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_CaseCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int i, result;
    int body;
    char *string;
	...
	if (i == (caseArgc-1)) {
            sprintf (interp->result, "extra case pattern with no body");
	    result = TCL_ERROR;
	    goto cleanup;
	}
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_CatchCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int result;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ConcatCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    (void) dummy;
    if (argc == 1) {
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ContinueCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    (void) dummy;
    if (argc != 1) {
	Tcl_AppendResult(interp, "wrong # args: should be \"", argv[0],
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ErrorCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_EvalCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int result;
    char *cmd;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ExprCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    (void) dummy;
    if (argc != 2) {
	Tcl_AppendResult(interp, "wrong # args: should be \"", argv[0],
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ForCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int result, value;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ForeachCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_FormatCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
	...
	*newPtr = 0;
    ...
    notEnoughArgs:
    sprintf (interp->result, "not enough arguments for all format specifiers");
    fmtError:
    if (dstSpace != TCL_RESULT_SIZE) {
	ckfree(dst);
    }
