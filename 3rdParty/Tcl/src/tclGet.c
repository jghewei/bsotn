 ...
 *
 * $Id: tclGet.c,v 1.1.1.1 2001/04/20 15:03:06 karl Exp $
 */
...
int
Tcl_GetInt(Tcl_Interp *interp, char *string, int *intPtr)
{
    char *end;
    int i;
...
int
Tcl_GetDouble(Tcl_Interp *interp, char *string, double *doublePtr)
{
    char *end;
    double d;
...
int
Tcl_GetBoolean(Tcl_Interp *interp, char *string, int *boolPtr)
{
    char c;
    char lowerCase[10];
    int i, length;
