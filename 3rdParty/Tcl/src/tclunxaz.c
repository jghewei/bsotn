 ...
 *
 * $Id: tclunxaz.c,v 1.1.1.1 2001/04/20 15:03:06 karl Exp $
 */
...
static const char *		GetFileType _ANSI_ARGS_((int mode));
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_CdCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    const char *dirName;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_CloseCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    OpenFile *filePtr;
    int result = TCL_OK;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_EofCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
    OpenFile *filePtr;
    (void) notUsed;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ExecCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ExitCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int value;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_FileCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    char *p;
    int length, statOp;
	...
	sprintf (interp->result, "%s", GetFileType((int) statBuf.st_mode));
	return TCL_OK;
    } else {
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_FlushCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
    OpenFile *filePtr;
    FILE *f;
    (void) notUsed;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_GetsCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
#   define BUF_SIZE 200
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_OpenCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
    Interp *iPtr = (Interp *) interp;
    int pipeline, fd;
    const char *access;
    const char *rdAccess = "r";
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_PwdCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_PutsCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    OpenFile *filePtr;
    FILE *f;
    int i, newline;
    const char *fileIdStdout = "stdout";
    const char *fileId;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ReadCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    OpenFile *filePtr;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_SeekCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
    OpenFile *filePtr;
    int offset, mode;
    (void) notUsed;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_SourceCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    (void) dummy;
    if (argc != 2) {
	Tcl_AppendResult(interp, "wrong # args: should be \"", argv[0],
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_TellCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
    OpenFile *filePtr;
    (void) notUsed;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_TimeCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int count, i, result;
    double timePer;
#if TCL_GETTOD
