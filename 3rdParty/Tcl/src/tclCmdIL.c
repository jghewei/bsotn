 ...
 *
 * $Id: tclCmdIL.c,v 1.1.1.1 2001/04/20 15:03:06 karl Exp $
 */
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_IfCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int i, result, value;
    (void) dummy;
 ...
 */
    ...
    /* ARGSUSED */
int
Tcl_IncrCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int value;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_InfoCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
	...
	for (argPtr = procPtr->argPtr; ; argPtr = argPtr->nextPtr) {
		...
		if (argPtr->defValue != NULL) {
		    ...
		    sprintf (iPtr->result, "1");
		} else {
		    if (Tcl_SetVar((Tcl_Interp *) iPtr, argv[4], "", 0)
			    == NULL) {
			goto defStoreError;
		    }
		    sprintf (iPtr->result, "0");
		}
		return TCL_OK;
	    }
	}
	...
	resPtr = getenv("TCL_LIBRARY");
	if (resPtr == NULL) {
#ifdef TCL_LIBRARY
	    Tcl_AppendResult(interp, TCL_LIBRARY, (char *) NULL);
#else
	    Tcl_AppendResult(interp, "there is no Tcl library at this installation", (char *) NULL);
	    return TCL_ERROR;
#endif
	}
	return TCL_OK;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_JoinCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    const char *defaultJoin = " ";
 ...
 */
    ...
    /* ARGSUSED */
int
Tcl_LindexCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    char *p, *element;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_LinsertCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ListCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    (void) dummy;
    if (argc < 2) {
	Tcl_AppendResult(interp, "wrong # args: should be \"", argv[0],
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_LlengthCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
{
    int count, result;
    char *element, *p;
    (void) dummy;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_LrangeCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_LreplaceCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_LsearchCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
    int listArgc;
    char **listArgv;
    int i, match;
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_LsortCmd(ClientData notUsed, Tcl_Interp *interp, int argc, char **argv)
{
    int listArgc;
    char **listArgv;
    (void) notUsed;
...
static int
SortCompareProc(const void *first, const void *second)
{
