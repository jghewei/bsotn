 ...
 *
 * $Id: tclalloc.c,v 1.1.1.1 2001/04/20 15:03:06 karl Exp $
 *
 */
 ...
 */
static void
ValidateMemory (struct mem_header *memHeaderP, char *file, 
 ...
 */
	/* ARGSUSED */
static int
MemoryCmd (ClientData clientData, Tcl_Interp *interp, int argc, char **argv)
{
    char *fileName;
