 ...
 *
 * $Id: tcl.h,v 1.2 2001/09/11 17:14:02 karl Exp $
 */
...
EXTERN void		Tcl_SetResult _ANSI_ARGS_((Tcl_Interp *interp,
			    const char *string, Tcl_FreeProc *freeProc));
EXTERN char *		Tcl_SetVar _ANSI_ARGS_((Tcl_Interp *interp,
			    char *varName, const char *newValue, int flags));
...
EXTERN int tcl_main (void);
EXTERN int tcl_single_command(char *cmdLine);
